...
export function Sidebar() {
  ...
  if (!mounted) {
    return (
      <aside className="w-[280px] h-screen border-r border-border-subtle bg-bg-surface flex-shrink-0" />
    )
  }
  ...
  return (
    <motion.aside
      ...
      className="relative flex flex-col h-screen border-r border-border-subtle bg-bg-surface flex-shrink-0 z-30 select-none overflow-hidden"
    >
      {/* Top Header (Fixed) */}
      ...
      <div className="flex-1 overflow-y-auto min-h-0 space-y-3 py-2">
          ...
          {isSidebarOpen && (
            <div className="relative flex items-center">
              ...
              <input
                ...
                className="w-full bg-bg-base border border-border-subtle focus:border-accent-primary/40 rounded-xl pl-8 pr-7 py-1.5 text-xs text-text-primary placeholder:text-text-muted focus:outline-none transition-colors"
              />
              {searchQuery && (
                <button
        ...
        {/* Navigation Links */}
        <div className="px-2 space-y-0.5 border-b border-border-subtle pb-3">
          {navItems.map((item) => {
      ...
      <div className="p-3 border-t border-border-subtle flex items-center gap-3 flex-shrink-0">
